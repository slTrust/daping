    ...
    <div>
      ...
      >
        ...
        <span slot="action" slot-scope="text, record">
          ...
          <a-dropdown>
            <a class="ant-dropdown-link">迁出/注销<a-icon type="down" /></a>
            <a-menu slot="overlay">
              <a-menu-item>
                <a-popconfirm title="确定迁出吗?" @confirm="() => moveout(record.id,1)">
                  <a>迁出</a>
                </a-popconfirm>
              </a-menu-item>
              <a-menu-item>
                <a-popconfirm title="确定注销吗?" @confirm="() => moveout(record.id,2)">
                  <a>注销</a>
                </a-popconfirm>
              </a-menu-item>
            </a-menu>
          ...
          <a @click="auditLogFrom(record)">审核日志</a>
          
        </span>
      </a-table>
    </div>

    <enterprise-work-order-modal-list ref="auditLog" @ok="modalFormOk"></enterprise-work-order-modal-list>
...
import EnterpriseWorkOrderModalList from './EnterpriseWorkOrderModalList'
...
export default {
  ...
  data() {
    return {
      ...
      url: {
        ...
        moveoutUrl: 'enterprise/enterpriseBaseInfo/moveout',
  ...
  methods: {
    ...
    moveout(id,code) {
      getAction(this.url.moveoutUrl, {id: id,code: code }).then((res) => {
        this.loadData();
        this.dictIndustry = res
      })
    },
