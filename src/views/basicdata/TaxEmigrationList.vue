<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button type="primary" icon="download" @click="handleExportXls3('税务迁出数据管理','/enterprise/enterpriseBaseInfoSW/exportSWXls')">导出</a-button>
      <a-upload
        name="file"
  ...
  data() {
    return {
      ...
      url: {
        ...
        taxEmigration: '/enterprise/enterpriseBaseInfo/taxEmigration',
    ...
    taxEmigration: function () {
      if (this.selectedRowKeys.length <= 0) {
        ...
        this.$confirm({
          ...
          onOk: function () {
            that.loading = true;
            getAction(that.url.taxEmigration, {ids: ids}).then((res) => {
              if (res.success) {
