<template>
  <a-row class="j-select-biz-component-box" type="flex" :gutter="8">
    ...
    <j-select-biz-dept-component-modal
      v-model="selectValue"
...
<script>
  import JSelectBizDeptComponentModal from './JSelectBizDeptComponentModal'

  export default {
    name: 'JSelectBizDeptComponent',
    components: { JSelectBizDeptComponentModal },
    props: {
      value: {
        type: String,
        default: ''
