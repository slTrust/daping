...
window._CONFIG['socketDomainURL'] = process.env.VUE_APP_API_SOCKET_URL
//单点登录地址
...
window._CONFIG['bigscreenStaticDomainURL'] = Vue.prototype.API_BASE_URL + '/bigscreen/common/static'
