...
export const constantRouterMap = [
  ...
  //       path: 'main',
  //       name: 'LedMain',
  //       component: () => import('@/views/led/LedMain')
  //     }
  //   ]
  // },
  {
  ...
  {
    path: '/bigscreen/main',
    component: () => import('@/views/bigscreen/main/Main')
  },
  {
    path: '/bigscreen/model',
    component: () => import('@/views/bigscreen/Model')
  },
  {
    path: '/bigscreen/service',
    component: () => import('@/views/bigscreen/Service')
  },
  {
    path: '/bigscreen/atlas',
